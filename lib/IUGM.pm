...
Readonly our $CONFIG_TEMP_DIR => 'temp_dir';
Readonly our $CONFIG_CACHE_FILEPATH => 'cache_filepath';
Readonly our $CONFIG_CACHE_LOCK_FILEPATH => 'cache_lock_filepath';

our @EXPORT_OK = qw(
    $CONFIG_TEMP_DIR
    $CONFIG_CACHE_FILEPATH
    $CONFIG_CACHE_LOCK_FILEPATH
);
